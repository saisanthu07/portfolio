    ...
    <section id="projects" ref={ref}>
      <div className="container">
        ...
        <div className="projects-grid">
          {projects.map((p, i) => (
            <div
              className={`project-card fade-in delay-${i + 1}${visible ? ' visible' : ''}`}
              key={p.id}
              onMouseMove={e => {
            ...
            >
              <div className="project-body">
                ...
                <div className="project-links">
                  {p.liveUrl && (
                    <a className="project-link primary" href={p.liveUrl} target="_blank" rel="noopener noreferrer">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
                      Live Demo
                    </a>
                  )}
                  <a className="project-link" href={p.githubUrl} target="_blank" rel="noopener noreferrer">
              ...
              <div className="project-img">
                <div className="project-img-placeholder">
                  <div className="project-img-placeholder-icon">{p.emoji}</div>
                  <span>{p.title}</span>
                </div>
              </div>
            </div>
